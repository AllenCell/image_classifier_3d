...
[![Documentation](https://github.com/aics-int/image_classifier_3d/workflows/Documentation/badge.svg)](https://aics-int.github.io/image_classifier_3d)
[![Code Coverage](https://codecov.io/gh/aics-int/image_classifier_3d/branch/master/graph/badge.svg)](https://codecov.io/gh/aics-int/image_classifier_3d)
...
## Documentation
For full package documentation please visit [aics-int.github.io/image_classifier_3d](https://aics-int.github.io/image_classifier_3d).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:aics-int/image_classifier_3d.git`
    * `git push -u origin master`
* Register image_classifier_3d with Codecov:
  ...
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/aics-int/image_classifier_3d/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/aics-int/image_classifier_3d/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/aics-int/image_classifier_3d/settings/branches), click `Add rule` and select the
