...
class LightningMNISTModel(LightningModule):
    ...
    def prepare_data(self):
        ...
        self.mnist_train = MNIST(self.hparams.data_root, 
                                 train=True, download=True, transform=transform)
        self.mnist_test = MNIST(self.hparams.data_root,
    ...
    def add_model_specific_args(parent_parser, root_dir):
        ...
        # data
        parser.add_argument('--data_root', default=os.path.join(root_dir, 'mnist'),
                            type=str)
